...
<div class="container2">
        <div class="row2">
            <div class="col-xl-12">
                <form action="{{route('anuncio_administrador.vista')}}">
                    <div class="form-row">
                        ...
                        <a href="{{route('anuncioadmin.nuevoanuncio')}}" class="btn btn-success">Nuevo</a>
                    </div>
                </form>
            </div>
    ...
    <div class="container">
        <h4>Anuncio del administrador</h4>
        <div class="row">
            <div class="col-lx-12">
                         ...
                         @foreach ($registros as $registro)
                            <tr>
                                <td>
                                    ...
                                    <form action="{{ route('anuncio_administrador.destroy', $registro->ID_ANUNCIO_ADMIN) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                ...
                                <td>{{$registro->ID_ANUNCIO_ADMIN}}</td>
